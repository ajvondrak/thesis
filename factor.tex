...
%\subsubsection{Colon Definitions}
...
Factor, even words are first-class objects), which by default is the
\factor|utf8| word from the \factor|io.encodings.utf8| vocabulary,
corresponding to a particular Unicode format.
