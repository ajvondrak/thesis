...
thus said to be a \term{concatenative} language: concatenating any two programs
denotes the composition of the functions the programs individually
denote\todo{cite and talk about Joy}.  Note that being stack-based is
...
concatenative languages\todo{cite Joy}.  % point-free, incl. citations
