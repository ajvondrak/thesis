...
of a design philosophy that aims to produce readable code focusing on short,
...
are defined.  The central data type of Factor's object system is called a
\term{tuple}, which is a class composed of named \term{slots}---like instance
