...
\autocite{young-factor}.  Its first incarnation was an embedded scripting language for a game that targeted the \gls{JVM}.  As such, its feature set was minimal.
