...
\Verb|exprs>vns| and \Verb|vns>insns| tables.  Unlike the local value
...
\Verb|vregs>vns| establishes congruence classes of value numbers.  At first,
...
instructions in \Verb|exprs>vns| and \Verb|vns>insns| are
