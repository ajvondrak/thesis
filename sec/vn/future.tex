...
\citeauthor{Cousot} formalize the salient properties of such interpretation
over lattices in a framework dubbed \term{abstract interpretation}.  To
...
operators to be defined by the rules of signs.  \Vref{fig:lattice} shows a
